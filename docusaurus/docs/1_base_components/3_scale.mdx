...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            according SVG element. `tickWidth` and/or `tickHeight` props needs
            to be set.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>`activeColor`</td>
        <td>
            Color for the tick that indicates the same value as the current knob
            value.
        </td>
    </tr>
    <tr>
        <td>`className`</td>
        <td>
            Will be passed as prop to the render SVG element of a tick or to the
    ...
    <tr>
        ...
        <td>
            ...
            is rendered. The function needs to return a SVG element. [See
            details bellow](#custom-function).
        </td>
    </tr>
</table>
