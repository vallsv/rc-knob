import {
    ...
    calculatePercentageFromMouseAngle,
} from '../src/utils';
...
describe('utils', () => {
    ...
    describe('calculatePercentageFromMouseAngle', () => {
        const params: [
            string,
            { mouseAngle: number; angleOffset: number; angleRange: number },
            number,
        ][] = [
            ['easy', { mouseAngle: 180, angleOffset: 0, angleRange: 360 }, 0.5],
            [
                'clockwise center',
                { mouseAngle: 0, angleOffset: 220, angleRange: 280 },
                0.5,
            ],
            [
                'clockwise too small',
                { mouseAngle: 210, angleOffset: 220, angleRange: 280 },
                0,
            ],
            [
                'clockwise too big',
                { mouseAngle: 150, angleOffset: 220, angleRange: 280 },
                1,
            ],
            [
                'anticlockwise center',
                { mouseAngle: 0, angleOffset: -220, angleRange: -280 },
                0.5,
            ],
            [
                'anticlockwise too small',
                { mouseAngle: 150, angleOffset: -220, angleRange: -280 },
                0,
            ],
            [
                'anticlockwise too big',
                { mouseAngle: 210, angleOffset: -220, angleRange: -280 },
                1,
            ],
            [
                'clockwise value',
                { mouseAngle: 10, angleOffset: 0, angleRange: 100 },
                0.1,
            ],
            [
                'anticlockwise value',
                { mouseAngle: 10, angleOffset: 100, angleRange: -100 },
                0.9,
            ],
        ];
    ...
    describe('snapPosition', () => {
        ...
        const params: [
            string,
            {
                position: { updated: boolean; percentage: number };
            ...
            [
                'normal',
                {
                    position: { updated: true, percentage: 0.56 },
                    state,
                    steps: 4,
                },
                180,
            ...
            [
                'second turn',
                {
                    position: { updated: true, percentage: 1.56 },
                    state,
                    steps: 4,
                },
                180,
